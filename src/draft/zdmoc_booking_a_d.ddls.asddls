...
define view entity ZDMOC_Booking_A_D
  as projection on ZDMOR_Booking_D
{
  key BookingUUID,
      ...
      /* Associations */
      _BookingSupplement: redirected to composition child ZDMOC_BookingSupplement_A_D,
      _BookingStatus, 
      _Carrier,
      _Connection,
      _Customer,
      _Travel: redirected to parent ZDMOC_Travel_A_D
}
