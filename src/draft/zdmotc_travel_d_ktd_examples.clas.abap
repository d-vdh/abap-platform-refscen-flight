...
CLASS ZDMOtc_travel_d_ktd_examples DEFINITION
  PUBLIC
  FINAL
  FOR TESTING
  DURATION SHORT
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS:
      ...
      existing_customerid         TYPE ZDMOi_travel_d-customerid   VALUE '123',
      another_existing_customerid TYPE ZDMOi_travel_d-customerid   VALUE '321',
      existing_agencyid           TYPE ZDMOi_travel_d-agencyid     VALUE '42',
      another_existing_agencyid   TYPE ZDMOi_travel_d-agencyid     VALUE '24',
      valid_date                  TYPE ZDMOi_travel_d-begindate    VALUE '20230101',
      valid_date_after_being_date TYPE ZDMOi_travel_d-enddate      VALUE '20230204',
      valid_currency_code         TYPE ZDMOi_travel_d-currencycode VALUE 'EUR',
    ...
    DATA:
      mapped      TYPE RESPONSE FOR MAPPED   EARLY ZDMOi_travel_d,
      failed      TYPE RESPONSE FOR FAILED   EARLY ZDMOi_travel_d,
      reported    TYPE RESPONSE FOR REPORTED EARLY ZDMOi_travel_d,
      read_result TYPE TABLE FOR READ RESULT ZDMOi_travel_d\\travel.
