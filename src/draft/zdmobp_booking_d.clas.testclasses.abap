...
CLASS ltc_booking IMPLEMENTATION.
  ...
  METHOD setbookingnumber_idempotence.
    DATA:
      ...
      bookings_to_test  TYPE STANDARD TABLE OF ZDMOr_booking_d WITH KEY bookinguuid,
      exp_bookings      TYPE TABLE FOR READ RESULT ZDMOr_travel_d\\booking,
  ...
  METHOD validatecustomer_success.
    ...
    DATA:
      ...
      booking_mock_data  TYPE STANDARD TABLE OF ZDMOa_booking_d,
      bookings_to_test   TYPE TABLE FOR VALIDATION ZDMOr_travel_d\\booking~validatecustomer,
  ...
  METHOD validatecustomer_initial.
    CONSTANTS:
      c_customer_id            TYPE ZDMOcustomer_id VALUE '123',
      c_customer_id_of_booking TYPE ZDMOcustomer_id VALUE '111'.
  ...
  METHOD validatecustomer_not_exist.
    CONSTANTS:
      c_customer_id            TYPE ZDMOcustomer_id VALUE '123',
      c_customer_id_of_booking TYPE ZDMOcustomer_id VALUE IS INITIAL.
  ...
  METHOD validateconnection_success.
    CONSTANTS:
      c_airline     TYPE ZDMOcarrier_id VALUE 'TS',
      c_connection  TYPE ZDMOconnection_id VALUE '123',
      c_flight_date TYPE ZDMOflight_date VALUE '20200202'.

    DATA:
      flight_mock_data  TYPE STANDARD TABLE OF ZDMOflight,
      booking_mock_data TYPE STANDARD TABLE OF ZDMOa_booking_d,
      bookings_to_test  TYPE TABLE FOR VALIDATION ZDMOr_travel_d\\booking~validateconnection,
      failed            TYPE RESPONSE FOR FAILED LATE  ZDMOr_travel_d,
      reported          TYPE RESPONSE FOR REPORTED LATE  ZDMOr_travel_d.
  ...
  METHOD validateconnection_not_exist.
    CONSTANTS:
      c_airline              TYPE ZDMOcarrier_id VALUE 'TS',
      c_connection           TYPE ZDMOconnection_id VALUE '123',
      c_connection_not_exist TYPE ZDMOconnection_id VALUE '321',
      c_flight_date          TYPE ZDMOflight_date VALUE '20200202'.
  ...
  METHOD validate_currency_success.
    DATA:
      booking_mock_data TYPE STANDARD TABLE OF ZDMOa_booking_d,
      bookings_to_test  TYPE TABLE FOR VALIDATION ZDMOr_travel_d\\booking~validatecurrencycode,
      failed            TYPE RESPONSE FOR FAILED   LATE ZDMOr_travel_d,
      reported          TYPE RESPONSE FOR REPORTED LATE ZDMOr_travel_d.
