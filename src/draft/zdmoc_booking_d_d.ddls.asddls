...
define view entity ZDMOC_Booking_D_D
  as projection on ZDMOR_Booking_D
{
  key BookingUUID,
      ...
      @Consumption.valueHelpDefinition: [ 
          { entity: {name: 'ZDMOI_Flight_StdVH', element: 'Price'},
      ...
      /* Associations */
      _BookingSupplement: redirected to composition child ZDMOC_BookingSupplement_D_D,
      _BookingStatus,
      _Carrier,
      _Connection,
      _Customer,
      _Travel: redirected to parent ZDMOC_Travel_D_D
}
