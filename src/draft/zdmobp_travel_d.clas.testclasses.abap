...
CLASS ltc_travel IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                               VALUE #(
                                   ( i_for_entity = 'ZDMOR_Travel_D'            )
                                   ( i_for_entity = 'ZDMOR_Booking_D'           )
                                   ( i_for_entity = 'ZDMOR_BookingSupplement_D' )
                                 )
                             ).
  ...
  METHOD settravelnumber_idempotence.
    DATA:
      travel_mock_data TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      travels_to_test  TYPE STANDARD TABLE OF ZDMOR_Travel_D WITH KEY TravelUUID,
      exp_travels      TYPE TABLE FOR READ RESULT ZDMOR_Travel_D\\travel,
      reported         TYPE RESPONSE FOR REPORTED LATE  ZDMOR_Travel_D.
    ...
    READ ENTITIES OF ZDMOR_Travel_D
      ENTITY Travel
  ...
  METHOD accepttravel.
    DATA:
      travel_mock_data   TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      travels_to_test    TYPE STANDARD TABLE OF ZDMOR_Travel_D WITH KEY TravelUUID,
      exp_travels_action TYPE TABLE FOR ACTION RESULT ZDMOR_Travel_D\\travel~acceptTravel,
      exp_travel_read    TYPE STRUCTURE FOR READ RESULT ZDMOR_Travel_D\\travel,
      result             TYPE TABLE FOR ACTION RESULT  ZDMOR_Travel_D\\Travel~acceptTravel,
      mapped             TYPE RESPONSE FOR MAPPED EARLY  ZDMOR_Travel_D,
      failed             TYPE RESPONSE FOR FAILED EARLY  ZDMOR_Travel_D,
      reported           TYPE RESPONSE FOR REPORTED EARLY  ZDMOR_Travel_D.
  ...
  METHOD rejecttravel.
    DATA:
      travel_mock_data   TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      travels_to_test    TYPE STANDARD TABLE OF ZDMOR_Travel_D WITH KEY TravelUUID,
      exp_travels_action TYPE TABLE FOR ACTION RESULT ZDMOR_Travel_D\\travel~rejectTravel,
      exp_travel_read    TYPE STRUCTURE FOR READ RESULT ZDMOR_Travel_D\\travel,
      result             TYPE TABLE FOR ACTION RESULT  ZDMOR_Travel_D\\Travel~rejectTravel,
      mapped             TYPE RESPONSE FOR MAPPED EARLY  ZDMOR_Travel_D,
      failed             TYPE RESPONSE FOR FAILED EARLY  ZDMOR_Travel_D,
      reported           TYPE RESPONSE FOR REPORTED EARLY  ZDMOR_Travel_D.
  ...
  METHOD deductdiscount_invalid_param.
    TYPES:
      t_keys TYPE TABLE FOR KEY OF ZDMOR_Travel_D\\Travel.
    DATA:
      travels_to_test TYPE TABLE FOR ACTION IMPORT ZDMOR_Travel_D\\travel~deductDiscount,
      result          TYPE TABLE FOR ACTION RESULT  ZDMOR_Travel_D\\Travel~deductDiscount,
      mapped          TYPE RESPONSE FOR MAPPED EARLY  ZDMOR_Travel_D,
      failed          TYPE RESPONSE FOR FAILED EARLY  ZDMOR_Travel_D,
      reported        TYPE RESPONSE FOR REPORTED EARLY  ZDMOR_Travel_D.
  ...
  METHOD deductdiscount_success.
    DATA:
      travel_mock_data   TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      travels_to_test    TYPE TABLE FOR ACTION IMPORT ZDMOR_Travel_D\\travel~deductdiscount,
      exp_travels_action TYPE TABLE FOR ACTION RESULT ZDMOR_Travel_D\\travel~deductdiscount,
      exp_travel_read    TYPE STRUCTURE FOR READ RESULT ZDMOR_Travel_D\\travel,
      result             TYPE TABLE FOR ACTION RESULT  ZDMOR_Travel_D\\Travel~deductdiscount,
      mapped             TYPE RESPONSE FOR MAPPED EARLY  ZDMOR_Travel_D,
      failed             TYPE RESPONSE FOR FAILED EARLY  ZDMOR_Travel_D,
  ...
  METHOD recalctotalprice_one_currency.
    ...
    CONSTANTS:
      booking_uuid1           TYPE ZDMOa_booking_d-booking_uuid VALUE 'B1',
      booking_uuid2           TYPE ZDMOa_booking_d-booking_uuid VALUE 'B2',
      bookingsupplement_uuid1 TYPE ZDMOa_bksuppl_d-booksuppl_uuid VALUE 'C1',
      bookingsupplement_uuid2 TYPE ZDMOa_bksuppl_d-booksuppl_uuid VALUE 'C2',
      bookingsupplement_uuid3 TYPE ZDMOa_bksuppl_d-booksuppl_uuid VALUE 'C3',
      bookingsupplement_uuid4 TYPE ZDMOa_bksuppl_d-booksuppl_uuid VALUE 'C4'.

    DATA:
      travel_mock_data            TYPE STANDARD TABLE OF ZDMOa_travel_d,
      booking_mock_data           TYPE STANDARD TABLE OF ZDMOa_booking_d,
      bookingsupplement_mock_data TYPE STANDARD TABLE OF ZDMOa_bksuppl_d,
      travels_to_test             TYPE TABLE FOR ACTION IMPORT ZDMOR_Travel_D\\travel~reCalcTotalPrice,
      exp_travel_read             TYPE TABLE FOR READ RESULT ZDMOR_Travel_D\\travel,
      mapped                      TYPE RESPONSE FOR MAPPED EARLY  ZDMOR_Travel_D,
      failed                      TYPE RESPONSE FOR FAILED EARLY  ZDMOR_Travel_D,
      reported                    TYPE RESPONSE FOR REPORTED EARLY  ZDMOR_Travel_D.
  ...
  METHOD setstatustoopen.
    DATA:
      travel_mock_data TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      travels_to_test  TYPE TABLE FOR DETERMINATION ZDMOR_Travel_D\\travel~setStatusToOpen,
      exp_travel_read  TYPE TABLE FOR READ RESULT ZDMOR_Travel_D\\travel,
      reported         TYPE RESPONSE FOR REPORTED LATE  ZDMOR_Travel_D.
  ...
  METHOD validatecustomer_success.
    ...
    DATA:
      ...
      travel_mock_data   TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      travels_to_test    TYPE TABLE FOR VALIDATION ZDMOR_Travel_D\\travel~validateCustomer,
      failed             TYPE RESPONSE FOR FAILED LATE  ZDMOR_Travel_D,
      reported           TYPE RESPONSE FOR REPORTED LATE  ZDMOR_Travel_D.
  ...
  METHOD validateagency_success.
    ...
    DATA:
      ...
      travel_mock_data TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      travels_to_test  TYPE TABLE FOR VALIDATION ZDMOR_Travel_D\\travel~validateagency,
      failed           TYPE RESPONSE FOR FAILED LATE  ZDMOR_Travel_D,
      reported         TYPE RESPONSE FOR REPORTED LATE  ZDMOR_Travel_D.
  ...
  METHOD validatedates_success.
    DATA:
      travel_mock_data TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      travels_to_test  TYPE TABLE FOR VALIDATION ZDMOR_Travel_D\\travel~validateDates,
      failed           TYPE RESPONSE FOR FAILED LATE  ZDMOR_Travel_D,
      reported         TYPE RESPONSE FOR REPORTED LATE  ZDMOR_Travel_D,
  ...
  METHOD get_instance_features.
    TYPES: t_instance_feature TYPE STRUCTURE FOR INSTANCE FEATURES RESULT ZDMOR_Travel_D\\travel,
           BEGIN OF t_check.
             INCLUDE TYPE t_instance_feature.
    TYPES: overallstatus TYPE ZDMOR_Travel_D-OverallStatus,
           END OF t_check,
    ...
    DATA:
      ...
      travel_mock_data   TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      travels_to_test    TYPE TABLE FOR INSTANCE FEATURES KEY ZDMOR_Travel_D\\travel,
      requested_features TYPE STRUCTURE FOR INSTANCE FEATURES REQUEST ZDMOR_Travel_D\\travel,
      act_result         TYPE TABLE FOR INSTANCE FEATURES RESULT ZDMOR_Travel_D\\travel,
      exp_result         TYPE TABLE FOR INSTANCE FEATURES RESULT ZDMOR_Travel_D\\travel,
      reported           TYPE RESPONSE FOR REPORTED EARLY ZDMOR_Travel_D,
      failed             TYPE RESPONSE FOR FAILED   EARLY ZDMOR_Travel_D.
  ...
  METHOD get_global_authorizations.
    DATA:
      requested_authorizations TYPE STRUCTURE FOR GLOBAL AUTHORIZATION REQUEST ZDMOR_Travel_D\\travel,
      exp_result               TYPE STRUCTURE FOR GLOBAL AUTHORIZATION RESULT ZDMOR_Travel_D\\travel,
      act_result               TYPE STRUCTURE FOR GLOBAL AUTHORIZATION RESULT ZDMOR_Travel_D\\travel,
      reported                 TYPE RESPONSE FOR REPORTED EARLY ZDMOR_Travel_D.
  ...
  METHOD get_instance_authorizations.
    CONSTANTS:
      c_agency1    TYPE ZDMOagency_id VALUE '1337',
      c_agency2    TYPE ZDMOagency_id VALUE '1338',
      c_country_de TYPE ZDMOagency-country_code VALUE 'US' ##NO_TEXT,
      c_country_us TYPE ZDMOagency-country_code VALUE 'DE' ##NO_TEXT.

    DATA:
      travel_mock_data         TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      agency_mock_data         TYPE STANDARD TABLE OF ZDMOagency,
      travels_to_test          TYPE TABLE FOR AUTHORIZATION KEY ZDMOR_Travel_D\\travel,
      requested_authorizations TYPE STRUCTURE FOR AUTHORIZATION REQUEST ZDMOR_Travel_D\\travel,
      act_result               TYPE TABLE FOR AUTHORIZATION RESULT ZDMOR_Travel_D\\travel,
      exp_result               TYPE TABLE FOR AUTHORIZATION RESULT ZDMOR_Travel_D\\travel,
      failed                   TYPE RESPONSE FOR FAILED EARLY ZDMOR_Travel_D,
      reported                 TYPE RESPONSE FOR REPORTED EARLY ZDMOR_Travel_D.
  ...
  METHOD precheck_create_provided.
    ...
    DATA:
      travel_mock_data TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      agency_mock_data TYPE STANDARD TABLE OF ZDMOagency,
      travels_to_test  TYPE TABLE FOR CREATE ZDMOR_Travel_D\\travel,
      failed           TYPE RESPONSE FOR FAILED EARLY ZDMOR_Travel_D,
      reported         TYPE RESPONSE FOR REPORTED EARLY ZDMOR_Travel_D.
  ...
  METHOD precheck_update_provided.
    ...
    DATA:
      travel_mock_data TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      agency_mock_data TYPE STANDARD TABLE OF ZDMOagency,
      travels_to_test  TYPE TABLE FOR UPDATE ZDMOR_Travel_D\\travel,
      failed           TYPE RESPONSE FOR FAILED EARLY ZDMOR_Travel_D,
      reported         TYPE RESPONSE FOR REPORTED EARLY ZDMOR_Travel_D.
  ...
  METHOD resume_success.
    ...
    DATA:
      travel_mock_data TYPE STANDARD TABLE OF ZDMOA_Travel_D,
      agency_mock_data TYPE STANDARD TABLE OF ZDMOagency,
      travels_to_test  TYPE TABLE FOR ACTION IMPORT ZDMOr_travel_d\\travel~resume,
      failed           TYPE RESPONSE FOR FAILED EARLY ZDMOR_Travel_D,
      reported         TYPE RESPONSE FOR REPORTED EARLY ZDMOR_Travel_D,
      mapped           TYPE RESPONSE FOR MAPPED ZDMOr_travel_d.
  ...
  METHOD validate_currency_success.
    DATA:
      travel_mock_data TYPE STANDARD TABLE OF ZDMOa_travel_d,
      travels_to_test  TYPE TABLE FOR VALIDATION ZDMOr_travel_d\\travel~validatecurrencycode,
      failed           TYPE RESPONSE FOR FAILED   LATE ZDMOr_travel_d,
      reported         TYPE RESPONSE FOR REPORTED LATE ZDMOr_travel_d.
