...
CLASS lhc_Supplement IMPLEMENTATION.
  ...
  METHOD augment.
    ...
    DATA: suppltext_for_new_suppl      TYPE TABLE FOR CREATE ZDMOI_Supplement\_SupplementText,
          suppltext_for_existing_suppl TYPE TABLE FOR CREATE ZDMOI_Supplement\_SupplementText,
          supplementtext_update        TYPE TABLE FOR UPDATE ZDMOI_SupplementText.
    ...
    DATA: suppl_text_tky_link TYPE STRUCTURE FOR READ LINK ZDMOI_Supplement\\Supplement\_SupplementText,
    ...
    MODIFY AUGMENTING ENTITIES OF ZDMOI_Supplement
      ENTITY Supplement
