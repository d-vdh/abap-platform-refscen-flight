CLASS ZDMOcx_supplement DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF price_required,
        msgid TYPE symsgid VALUE 'ZDMOCM_SUPPLEMENT',
    ...
    DATA:
      mv_supplement_category TYPE ZDMOsupplement_category,
      mv_currencycode        TYPE ZDMOcurrency_code,
    ...
    METHODS:
      constructor
        IMPORTING
          ...
          supplement_category TYPE ZDMOsupplement_category         OPTIONAL
          currencycode        TYPE ZDMOcurrency_code               OPTIONAL
...
CLASS ZDMOCX_SUPPLEMENT IMPLEMENTATION.
