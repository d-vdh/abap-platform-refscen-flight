...
CLASS ltd_fields_handler DEFINITION CREATE PUBLIC.
  ...
  PRIVATE SECTION.
    DATA:
      max_supplement_id TYPE ZDMOsupplement_id VALUE 0.
...
CLASS ltd_fields_handler IMPLEMENTATION.
  ...
  METHOD if_botd_bufdbl_fields_handler~set_readonly_fields.
    CASE entity_name.
      WHEN 'ZDMOI_SUPPLEMENT'.
        CASE operation.
          WHEN if_abap_behv=>op-m-create.
            TYPES: ty_create_instances TYPE TABLE FOR CREATE ZDMOi_supplement.
...
CLASS ltcl_tdf_buffer DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS:
      cv_i_bdef_name TYPE abp_root_entity_name VALUE 'ZDMOI_Supplement' ##NO_TEXT.
    ...
    DATA:
      mapped     TYPE RESPONSE FOR MAPPED   EARLY ZDMOc_supplement,
      failed     TYPE RESPONSE FOR FAILED   EARLY ZDMOc_supplement,
      reported   TYPE RESPONSE FOR REPORTED EARLY ZDMOc_supplement,
      i_mapped   TYPE RESPONSE FOR MAPPED   EARLY ZDMOi_supplement,
      i_failed   TYPE RESPONSE FOR FAILED   EARLY ZDMOi_supplement,
      i_reported TYPE RESPONSE FOR REPORTED EARLY ZDMOi_supplement.
...
CLASS ltcl_tdf_buffer IMPLEMENTATION.
  ...
  METHOD supplement_create.
    " Test
    DATA:
      c_create TYPE STRUCTURE FOR CREATE ZDMOc_supplement\\supplement,
      i_create TYPE STRUCTURE FOR CREATE ZDMOi_supplement\\supplement.
    ...
    MODIFY ENTITIES OF ZDMOc_supplement
      ENTITY supplement
    ...
    READ ENTITIES OF ZDMOi_supplement
      ENTITY supplement
  ...
  METHOD supplement_create_text_update.
    ...
    DATA:
      c_create              TYPE STRUCTURE FOR CREATE ZDMOc_supplement\\supplement,
      c_update              TYPE STRUCTURE FOR UPDATE ZDMOc_supplement\\supplement,
      c_supplement_act      TYPE STRUCTURE FOR UPDATE ZDMOc_supplement\\supplement,
      c_supplement_exp      TYPE STRUCTURE FOR UPDATE ZDMOc_supplement\\supplement,
      i_supplement_act      TYPE STRUCTURE FOR UPDATE ZDMOi_supplement\\supplement,
      i_supplement_exp      TYPE STRUCTURE FOR UPDATE ZDMOi_supplement\\supplement,
      i_supplement_text_act TYPE STRUCTURE FOR UPDATE ZDMOi_supplement\\supplementtext.
  ...
  METHOD supplement_update_text_create.
    ...
    MODIFY ENTITIES OF ZDMOi_supplement
      ENTITY supplement
        CREATE
          AUTO FILL CID
          FIELDS ( supplementcategory price currencycode )
    ...
    DATA:
      c_update TYPE STRUCTURE FOR UPDATE ZDMOc_supplement\\supplement,
      i_update TYPE STRUCTURE FOR UPDATE ZDMOi_supplement\\supplement.
  ...
  METHOD supplement_update_text_update.
    " Preparation
    DATA:
      i_supplement_create      TYPE STRUCTURE FOR CREATE ZDMOi_supplement\\supplement,
      i_supplement_text_create TYPE STRUCTURE FOR CREATE ZDMOi_supplement\\supplement\_supplementtext.
  ...
  METHOD update_with_invalid_keys.
    ...
    DATA:
      c_update_no_key      TYPE STRUCTURE FOR UPDATE ZDMOc_supplement\\supplement,
      c_update_invalid_key TYPE STRUCTURE FOR UPDATE ZDMOc_supplement\\supplement,
      i_update             TYPE STRUCTURE FOR UPDATE ZDMOi_supplement\\supplement.
  ...
  METHOD update_invalid_keys_descr.
    ...
    DATA:
      c_update_no_flag     TYPE STRUCTURE FOR UPDATE ZDMOc_supplement\\supplement,
      c_update_invalid_key TYPE STRUCTURE FOR UPDATE ZDMOc_supplement\\supplement,
      i_update             TYPE STRUCTURE FOR UPDATE ZDMOi_supplement\\supplement.
...
CLASS ltd_custom_test_double DEFINITION FOR TESTING.
  PUBLIC SECTION.
    ...
    CONSTANTS:
      supplement_entity_name TYPE abp_root_entity_name VALUE 'ZDMOI_SUPPLEMENT' ##NO_TEXT,
      text_entity_name       TYPE abp_root_entity_name VALUE 'ZDMOI_SUPPLEMENTTEXT' ##NO_TEXT,
      text_sub_name          TYPE abp_behv_changes-sub_name VALUE '_SUPPLEMENTTEXT' ##NO_TEXT.

    DATA:
      supplement_create TYPE TABLE FOR CREATE ZDMOi_supplement\\supplement,
      supplement_update TYPE TABLE FOR UPDATE ZDMOi_supplement\\supplement,
      supplement_failed TYPE RESPONSE FOR FAILED ZDMOi_supplement,

      text_create       TYPE TABLE FOR CREATE ZDMOi_supplement\\supplement\_supplementtext,
      text_update       TYPE TABLE FOR UPDATE ZDMOi_supplement\\supplementtext,

      text_rba_link     TYPE TABLE FOR READ LINK   ZDMOi_supplement\\supplement\_supplementtext,

      text_read_failed  TYPE RESPONSE FOR FAILED ZDMOi_supplement.
ENDCLASS.
...
CLASS ltd_custom_test_double IMPLEMENTATION.
  ...
  METHOD if_abap_behavior_testdouble~read.
    TYPES:
      key         TYPE STRUCTURE FOR READ IMPORT ZDMOi_supplement\\supplement\_supplementtext.
