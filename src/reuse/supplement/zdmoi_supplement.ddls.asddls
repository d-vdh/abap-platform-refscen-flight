...
define root view entity ZDMOI_Supplement
  as select from ZDMOsupplement as supplement

  composition [0..*] of ZDMOI_SupplementText        as _SupplementText
  association [0..1] to I_Currency                   as _Currency           on $projection.CurrencyCode = _Currency.Currency
  association [0..1] to ZDMOI_SupplementCategory_VH as _SupplementCategory on $projection.SupplementCategory = _SupplementCategory.SupplementCategory
