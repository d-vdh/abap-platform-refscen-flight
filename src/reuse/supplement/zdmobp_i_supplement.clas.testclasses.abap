...
CLASS ltc_supplement DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA:
      mapped        TYPE RESPONSE FOR MAPPED   EARLY ZDMOi_supplement,
      failed        TYPE RESPONSE FOR FAILED   EARLY ZDMOi_supplement,
      reported      TYPE RESPONSE FOR REPORTED EARLY ZDMOi_supplement,
      failed_late   TYPE RESPONSE FOR FAILED   LATE  ZDMOi_supplement,
      reported_late TYPE RESPONSE FOR REPORTED LATE  ZDMOi_supplement.
...
CLASS ltc_supplement IMPLEMENTATION.
  ...
  METHOD validate_price_success.
    DATA:
      supplement  TYPE ZDMOsupplement,
      supplements TYPE STANDARD TABLE OF ZDMOsupplement.

    supplement = VALUE ZDMOsupplement(
        supplement_id       = 'XX123'
  ...
  METHOD validate_price_failed.
    ...
    DATA:
      supplements     TYPE STANDARD TABLE OF ZDMOsupplement WITH KEY supplement_id,
  ...
  METHOD earlynumbering_idempotency.
    DATA:
      entity          TYPE STRUCTURE FOR CREATE ZDMOi_supplement\\supplement,
  ...
  METHOD get_global_authorizations.
    DATA:
      requested_authorizations TYPE STRUCTURE FOR GLOBAL AUTHORIZATION REQUEST ZDMOi_supplement\\supplement,
      result                   TYPE STRUCTURE FOR GLOBAL AUTHORIZATION RESULT ZDMOi_supplement\\supplement,
      reported                 TYPE RESPONSE  FOR REPORTED EARLY ZDMOi_supplement.
