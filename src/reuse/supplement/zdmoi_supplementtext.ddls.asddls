...
define view entity ZDMOI_SupplementText
  as select from ZDMOsuppl_text as SupplementText

  association        to parent ZDMOI_Supplement as _Supplement on $projection.SupplementID = _Supplement.SupplementID
