...
define view entity ZDMOI_Flight
  as select from ZDMOflight as Flight

  association [1] to ZDMOI_Carrier as _Airline         on $projection.AirlineID = _Airline.AirlineID
  association [1] to ZDMOI_Connection as _Connection   on $projection.ConnectionID = _Connection.ConnectionID 
...

{
  ...
  key Flight.carrier_id     as AirlineID,
      ...
      @Consumption.valueHelpDefinition: [{ entity: { name: 'ZDMOI_Connection_StdVH', element: 'ConnectionID'}, 
