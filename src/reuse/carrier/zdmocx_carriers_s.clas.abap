CLASS ZDMOcx_carriers_s DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF name_required,
        msgid TYPE symsgid VALUE 'ZDMOCM_CARRIER_S',
    ...
    DATA:
      mv_airline_id    TYPE ZDMOcarrier_id,
    ...
    METHODS:
      constructor
        IMPORTING
          ...
          airline_id    TYPE ZDMOcarrier_id         OPTIONAL
...
CLASS ZDMOCX_CARRIERS_S IMPLEMENTATION.
