CLASS ZDMOcx_agency DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      message_class TYPE symsgid VALUE 'ZDMOCM_AGENCY',
    ...
    DATA:
      mv_country_code TYPE ZDMOR_AgencyTP-CountryCode,
      mv_numbers_left TYPE i,
      mv_attachment     TYPE ZDMOR_AgencyTP-attachment,
      mv_mimetype       TYPE ZDMOR_AgencyTP-mimetype,
      mv_filename       TYPE ZDMOR_AgencyTP-Filename.
    ...
    METHODS:
      constructor
        IMPORTING
          ...
          countrycode  TYPE ZDMOR_AgencyTP-CountryCode      OPTIONAL
          numbers_left TYPE i                                OPTIONAL
          attachment   TYPE ZDMOR_AgencyTP-attachment      OPTIONAL
          mimetype     TYPE ZDMOR_AgencyTP-mimetype        OPTIONAL
          filename     TYPE ZDMOR_AgencyTP-Filename        OPTIONAL
