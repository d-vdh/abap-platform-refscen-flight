...
CLASS lcl_abstract DEFINITION ABSTRACT CREATE PUBLIC.
  ...
  PROTECTED SECTION.
    TYPES:
      ts_agency_with_indicators TYPE ZDMOagency WITH INDICATORS control.
...
CLASS lcl_slogan DEFINITION
  ...
  PUBLIC SECTION.
    TYPES:
      BEGIN OF t_slogan,
        id          TYPE i,
        text        TYPE ZDMOzz_free_text_comment,
...
CLASS lcl_slogan IMPLEMENTATION.
  ...
  METHOD generate_slogan.
    ...
    UPDATE ZDMOagency FROM TABLE @gt_agency INDICATORS SET STRUCTURE control.
  ENDMETHOD.
...
CLASS lcl_review_generator DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      tt_review                 TYPE STANDARD TABLE OF ZDMOzz_agn_reva WITH KEY agency_id review_id.
  ...
  PRIVATE SECTION.
    ...
    METHODS:
      ...
      _get_review_rating_avg
        RETURNING
          VALUE(rv_review_rating_average) TYPE ZDMOzz_rating.
...
CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS:
      constructor
        IMPORTING
          is_agency         TYPE ZDMOagency
          iv_rating_average TYPE ZDMOzz_rating,
      generate
        RETURNING
          VALUE(rs_review) TYPE ZDMOzz_agn_reva.

  PROTECTED SECTION.
    DATA:
      mv_rating_average TYPE ZDMOzz_rating.

  PRIVATE SECTION.
    TYPES:
      BEGIN OF ts_id_map,
        agency_id TYPE ZDMOagency_id,
        review_id TYPE ZDMOzz_review_id,
      END OF ts_id_map,
    ...
    METHODS:
      _get_review_rating
        IMPORTING
          iv_target_rating        TYPE ZDMOzz_rating
        RETURNING
          VALUE(rv_review_rating) TYPE ZDMOzz_rating,
    ...
    DATA:
      ms_agency TYPE ZDMOagency,
      ms_review TYPE ZDMOzz_agn_reva.
ENDCLASS.
  ...
  PUBLIC SECTION.
    TYPES:
      ...
      BEGIN OF t_review_text_edges,
        id                 TYPE i,
        followed_by_rating TYPE ZDMOzz_rating,
        followed_by        TYPE i,
    ...
    METHODS:
      generate_text_for_agency
        IMPORTING
          is_agency      TYPE ZDMOagency
        RETURNING
          VALUE(rv_text) TYPE ZDMOzz_free_text_comment.
  PROTECTED SECTION.
  PRIVATE SECTION.
    CONSTANTS:
    ...
    DATA:
      mv_rating       TYPE ZDMOzz_rating,
      ms_agency       TYPE ZDMOagency,
      mv_text         TYPE ZDMOzz_free_text_comment,
...
CLASS lcl_review_generator IMPLEMENTATION.
  ...
  METHOD generate_reviews.
    ...
    DELETE FROM ZDMOzz_agn_reva.                       "#EC CI_NOWHERE

    INSERT ZDMOzz_agn_reva FROM TABLE @mt_reviews_to_create.
