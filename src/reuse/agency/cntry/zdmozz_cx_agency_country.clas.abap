CLASS ZDMOzz_cx_agency_country DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      message_class TYPE symsgid VALUE 'ZDMOZZ_AGENCY_CNTRY',
    ...
    DATA:
      mv_phone_number TYPE ZDMOI_Agency-PhoneNumber,
      mv_COUNTRY_CODE TYPE ZDMOI_Agency-CountryCode.
    ...
    METHODS:
      constructor
        IMPORTING
          ...
          phonenumber TYPE ZDMOi_agency-PhoneNumber        OPTIONAL
          countrycode TYPE ZDMOi_agency-CountryCode        OPTIONAL
...
CLASS ZDMOZZ_CX_AGENCY_COUNTRY IMPLEMENTATION.
