...
define view entity ZDMOC_BookSuppl_Processor_M
  as projection on ZDMOI_BookSuppl_M
{
  ...
  key booking_supplement_id       as BookingSupplementID,
      ...
      /* Associations */
      _Travel  : redirected to ZDMOC_Travel_Processor_M,
      _Booking : redirected to parent ZDMOC_Booking_Processor_M,
      _Product
}
