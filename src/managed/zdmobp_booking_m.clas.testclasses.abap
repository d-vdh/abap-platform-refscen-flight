...
CLASS ltcl_booking DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS:
      travel_id1  TYPE ZDMOtravel_id VALUE '11',
      travel_id2  TYPE ZDMOtravel_id VALUE '12',
      travel_id3  TYPE ZDMOtravel_id VALUE '13',
      travel_id4  TYPE ZDMOtravel_id VALUE '14',
      booking_id1 TYPE ZDMObooking_id VALUE '21',
      booking_id2 TYPE ZDMObooking_id VALUE '22',
      booking_id3 TYPE ZDMObooking_id VALUE '23',
      booking_id4 TYPE ZDMObooking_id VALUE '24',
...
CLASS ltcl_booking IMPLEMENTATION.
  ...
  METHOD validatestatus_success.
    DATA:
      ...
      bookings_to_test  TYPE TABLE FOR VALIDATION ZDMOi_travel_m\\booking~validatestatus,
  ...
  METHOD get_instance_features.
    TYPES: t_instance_feature TYPE STRUCTURE FOR INSTANCE FEATURES RESULT ZDMOi_travel_m\\booking,
           BEGIN OF t_check.
             INCLUDE TYPE t_instance_feature.
    TYPES: booking_status TYPE ZDMOi_booking_m-booking_status,
           END OF t_check,
    ...
    DATA:
      ...
      booking_mock_data  TYPE STANDARD TABLE OF ZDMObooking_m,
      travels_to_test    TYPE TABLE FOR INSTANCE FEATURES KEY ZDMOi_travel_m\\booking,
      requested_features TYPE STRUCTURE FOR INSTANCE FEATURES REQUEST ZDMOi_travel_m\\booking,
      act_result         TYPE TABLE FOR INSTANCE FEATURES RESULT ZDMOi_travel_m\\booking,
      exp_result         TYPE TABLE FOR INSTANCE FEATURES RESULT ZDMOi_travel_m\\booking,
  ...
  METHOD earlynumbering_cba_new_number.
    DATA:
      booking_mock_data            TYPE STANDARD TABLE OF ZDMObooking_m,
      booking_supplement_mock_data TYPE STANDARD TABLE OF ZDMObooksuppl_m,
      exp_travel_read              TYPE TABLE FOR READ RESULT ZDMOi_travel_m\\booking,
      mapped                       TYPE RESPONSE FOR MAPPED EARLY  ZDMOi_travel_m,
      failed                       TYPE RESPONSE FOR FAILED EARLY  ZDMOi_travel_m,
      reported                     TYPE RESPONSE FOR REPORTED EARLY  ZDMOi_travel_m,
      entities                     TYPE TABLE FOR CREATE ZDMOi_travel_m\\booking\_booksupplement.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = CONV ZDMObooking_supplement_id( '1' )
        act = VALUE ZDMObooking_supplement_id( mapped-booksuppl[ %cid = '1b1' ]-booking_supplement_id )
      ).

    cl_abap_unit_assert=>assert_equals(
        exp = CONV ZDMObooking_supplement_id( '2' )
        act = VALUE ZDMObooking_supplement_id( mapped-booksuppl[ %cid = '2b1' ]-booking_supplement_id )
      ).

    cl_abap_unit_assert=>assert_equals(
        exp = CONV ZDMObooking_supplement_id( '2' )
        act = VALUE ZDMObooking_supplement_id( mapped-booksuppl[ %cid = '3b1' ]-booking_supplement_id )
      ).

    cl_abap_unit_assert=>assert_equals(
        exp = CONV ZDMObooking_supplement_id( '4' )
        act = VALUE ZDMObooking_supplement_id( mapped-booksuppl[ %cid = '4b1' ]-booking_supplement_id )
      ).
  ENDMETHOD.
  ...
  METHOD calculatetotalprice.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = CONV ZDMOtotal_price( c_flight_price * lines( booking_mock_data ) )
  ...
  METHOD validate_currency_success.
    DATA:
      booking_mock_data TYPE STANDARD TABLE OF ZDMObooking_m,
      bookings_to_test  TYPE TABLE FOR VALIDATION ZDMOi_travel_m\\booking~validatecurrencycode,
      failed            TYPE RESPONSE FOR FAILED   LATE ZDMOi_travel_m,
      reported          TYPE RESPONSE FOR REPORTED LATE ZDMOi_travel_m.
