...
PUBLIC SECTION.
  ...
  METHODS get_agency_data
            RETURNING VALUE(rs_agency) TYPE ZDMOagency.
  METHODS get_customer_data
            RETURNING VALUE(rs_customer) TYPE ZDMOcustomer.
  METHODS get_carrier_data
            RETURNING VALUE(rs_carrier) TYPE ZDMOcarrier.

PRIVATE SECTION.
   class-data gt_agency TYPE STANDARD TABLE OF ZDMOagency.
   class-data gt_customer TYPE STANDARD TABLE OF ZDMOcustomer.
   class-data gt_carrier TYPE STANDARD TABLE OF ZDMOcarrier.
