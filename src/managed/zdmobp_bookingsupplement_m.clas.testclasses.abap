...
CLASS ltcl_bookingsupplement DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS:
      ...
      booking_supplement_id1 TYPE ZDMObooking_supplement_id VALUE '31',
      booking_supplement_id2 TYPE ZDMObooking_supplement_id VALUE '32',
      booking_supplement_id3 TYPE ZDMObooking_supplement_id VALUE '33',
      booking_supplement_id4 TYPE ZDMObooking_supplement_id VALUE '34',
...
CLASS ltcl_bookingsupplement IMPLEMENTATION.
  ...
  METHOD calculatetotalprice.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = CONV ZDMOtotal_price( c_supplement_price * lines( booking_supplement_mock_data ) )
  ...
  METHOD validate_currency_success.
    DATA:
      booking_supplement_mock_data TYPE STANDARD TABLE OF ZDMObooksuppl_m,
      booking_supplements_to_test  TYPE TABLE FOR VALIDATION ZDMOi_travel_m\\booksuppl~validatecurrencycode,
