...
define view entity ZDMOC_Booking_Processor_M
  as projection on ZDMOI_Booking_M
{
      @UI.facet: [ { id:            'Booking',
                     purpose:       #STANDARD,
  ...
  key booking_id         as BookingID,
      ...
      @Consumption.valueHelpDefinition: [ 
          { entity: {name: 'ZDMOI_Flight_StdVH', element: 'AirlineID'},
      ...
      @Consumption.valueHelpDefinition: [ 
          { entity: {name: 'ZDMOI_Flight_StdVH', element: 'ConnectionID'},
            additionalBinding: [ { localElement: 'FlightDate',   element: 'FlightDate',   usage: #RESULT},
      ...
      @Consumption.valueHelpDefinition: [ 
          { entity: {name: 'ZDMOI_Flight_StdVH', element: 'FlightDate'},
      ...
      @Consumption.valueHelpDefinition: [{ entity: { name: 'ZDMOI_Booking_Status_VH', element: 'BookingStatus' }}]
      ...
      /* Associations */
      _Travel         : redirected to parent ZDMOC_Travel_Processor_M,
      _BookSupplement : redirected to composition child ZDMOC_BookSuppl_Processor_M,
      _Customer,
      _Carrier,
      _BookingStatus
