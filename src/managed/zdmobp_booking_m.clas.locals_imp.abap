...
CLASS lhc_booking IMPLEMENTATION.
  ...
  METHOD calculatetotalprice.
    DATA: travel_ids TYPE STANDARD TABLE OF ZDMOi_travel_m WITH UNIQUE HASHED KEY key COMPONENTS travel_id.
  ...
  METHOD earlynumbering_cba_booksupplem.
    DATA: max_booking_suppl_id TYPE ZDMObooking_supplement_id .
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<booking_group>) GROUP BY <booking_group>-%tky.
      ...
      max_booking_suppl_id = REDUCE #( INIT max = CONV ZDMObooking_supplement_id( '0' )
                                       ...
                                       NEXT max = COND ZDMObooking_supplement_id( WHEN   booksuppl-target-booking_supplement_id > max
      ...
      max_booking_suppl_id = REDUCE #( INIT max = max_booking_suppl_id
                                       ...
                                       NEXT max = COND ZDMObooking_supplement_id( WHEN   target-booking_supplement_id > max
