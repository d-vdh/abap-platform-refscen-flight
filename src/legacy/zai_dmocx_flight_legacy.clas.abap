CLASS ZAI_DMOcx_flight_legacy DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZAI_DMOCM_FLIGHT_LEGAC',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE 'ZAI_DMOCM_FLIGHT_LEGAC',
...
CLASS ZAI_DMOcx_flight_legacy IMPLEMENTATION.
