CLASS ZDMOtc_flight_travel_api DEFINITION
  PUBLIC
  ABSTRACT
  CREATE PUBLIC
  FOR TESTING
...
CLASS ZDMOtc_flight_travel_api IMPLEMENTATION.
  ...
  METHOD cuerd_travel_early_numbering.
    ...
    DATA ls_travel_inx TYPE ZDMOs_travel_inx.
    DATA ls_travel     TYPE ZDMOtravel.
    DATA lt_messages   TYPE ZDMOt_message.
    ...
    cl_abap_unit_assert=>assert_equals( act = ls_travel-status       exp = CONV ZDMOtravel_status( ZDMOif_flight_legacy=>travel_status-new ) ).
  ...
  METHOD cuerd_travel_late_numbering.
    ...
    DATA ls_travel     TYPE ZDMOtravel.
    DATA lt_messages   TYPE ZDMOt_message.
    DATA lt_travel_mapping TYPE ZDMOif_flight_legacy=>tt_ln_travel_mapping.
