CLASS ZDMOcx_flight_legacy DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZDMOCM_FLIGHT_LEGAC',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE 'ZDMOCM_FLIGHT_LEGAC',
...
CLASS ZDMOCX_FLIGHT_LEGACY IMPLEMENTATION.
