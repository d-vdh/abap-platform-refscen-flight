...
CLASS lhc_travel DEFINITION
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_failed    TYPE TABLE FOR FAILED   ZDMOi_travel_u.
    TYPES tt_travel_reported  TYPE TABLE FOR REPORTED ZDMOi_travel_u.
...
********************************************************************************
  METHOD get_instance_features.
    READ ENTITIES OF ZDMOI_Travel_U IN LOCAL MODE
      ENTITY Travel
...
**********************************************************************
  METHOD create.
    DATA: messages   TYPE ZDMOt_message,
          travel_in  TYPE ZDMOtravel,
          travel_out TYPE ZDMOtravel.
...
**********************************************************************
  METHOD update.
    DATA: messages TYPE ZDMOt_message,
          travel   TYPE ZDMOtravel,
          travelx  TYPE ZDMOs_travel_inx. "refers to x structure (> BAPIs)
...
**********************************************************************
  METHOD lock.
    TRY.
        ...
        DATA(lock) = cl_abap_lock_object_factory=>get_instance( iv_name = 'ZDMOETRAVEL' ).
...
**********************************************************************
  METHOD rba_Booking.
    DATA: travel_out  TYPE ZDMOtravel,
          booking_out TYPE ZDMOt_booking,
...
**********************************************************************
  METHOD cba_Booking.
    DATA: messages        TYPE ZDMOt_message,
          booking_old     TYPE ZDMOt_booking,
          booking         TYPE ZDMObooking,
          last_booking_id TYPE ZDMObooking_id VALUE '0'.
...
CLASS lsc_I_TRAVEL_U IMPLEMENTATION.
  ...
  METHOD adjust_numbers.
    ...
    DATA: travel_mapping       TYPE ZDMOif_flight_legacy=>tt_ln_travel_mapping,
