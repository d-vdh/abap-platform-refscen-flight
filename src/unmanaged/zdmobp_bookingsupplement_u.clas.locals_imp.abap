...
**********************************************************************
  METHOD update.
    DATA: messages         TYPE ZDMOt_message,
          book_supplements TYPE ZDMObook_suppl.
    ...
    LOOP AT keys ASSIGNING FIELD-SYMBOL(<bookingsupplement>).
      ...
      CALL FUNCTION 'ZDMOFLIGHT_TRAVEL_UPDATE'
        EXPORTING
          is_travel              = VALUE ZDMOs_travel_in( travel_id = <bookingsupplement>-travelid )
          is_travelx             = VALUE ZDMOs_travel_inx( travel_id = <bookingsupplement>-travelid )
          it_booking             = VALUE ZDMOt_booking_in( ( booking_id = <bookingsupplement>-bookingid ) )
          it_bookingx            = VALUE ZDMOt_booking_inx( ( booking_id = <bookingsupplement>-bookingid ) )
          it_booking_supplement  = VALUE ZDMOt_booking_supplement_in( (  booking_supplement_id = <bookingsupplement>-bookingSupplementid
                                                                          booking_id            = <bookingsupplement>-BookingID ) )
          it_booking_supplementx = VALUE ZDMOt_booking_supplement_inx( ( booking_supplement_id = <bookingsupplement>-bookingsupplementid
                                                                          booking_id            = <bookingsupplement>-bookingid
...
**********************************************************************
  METHOD read.
    ...
    DATA: booksuppls_out TYPE ZDMOt_booking_supplement,
          messages       TYPE ZDMOt_message.
...
**********************************************************************
  METHOD rba_Booking.
    DATA: booking_out TYPE ZDMOt_booking,
