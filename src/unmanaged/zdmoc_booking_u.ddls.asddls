...
define view entity ZDMOC_Booking_U
  as projection on ZDMOI_Booking_U
...
//      LastChangedAt,
      /* Associations */
      //ZDMOI_Booking_U
      _Travel: redirected to parent ZDMOC_Travel_U,
      _BookSupplement: redirected to composition child ZDMOC_BookingSupplement_U,
      _Carrier,
      _Connection,
      _Customer
}
