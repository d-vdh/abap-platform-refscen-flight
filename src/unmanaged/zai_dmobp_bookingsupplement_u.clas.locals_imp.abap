...
**********************************************************************
  METHOD update.
    DATA: messages         TYPE ZAI_DMOt_message,
          book_supplements TYPE ZAI_DMObook_suppl.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<bookingsupplement>).
      ...
      CALL FUNCTION 'ZAI_DMOFLIGHT_TRAVEL_UPDATE'
        EXPORTING
          is_travel              = VALUE ZAI_DMOs_travel_in( travel_id = <bookingsupplement>-travelid )
          is_travelx             = VALUE ZAI_DMOs_travel_inx( travel_id = <bookingsupplement>-travelid )
          it_booking_supplement  = VALUE ZAI_DMOt_booking_supplement_in( ( CORRESPONDING #( book_supplements ) ) )
          it_booking_supplementx = VALUE ZAI_DMOt_booking_supplement_inx( (
    ...
    LOOP AT keys ASSIGNING FIELD-SYMBOL(<bookingsupplement>).
      ...
      CALL FUNCTION 'ZAI_DMOFLIGHT_TRAVEL_UPDATE'
        EXPORTING
          is_travel              = VALUE ZAI_DMOs_travel_in( travel_id = <bookingsupplement>-travelid )
          is_travelx             = VALUE ZAI_DMOs_travel_inx( travel_id = <bookingsupplement>-travelid )
          it_booking             = VALUE ZAI_DMOt_booking_in( ( booking_id = <bookingsupplement>-bookingid ) )
          it_bookingx            = VALUE ZAI_DMOt_booking_inx( ( booking_id = <bookingsupplement>-bookingid ) )
          it_booking_supplement  = VALUE ZAI_DMOt_booking_supplement_in( (  booking_supplement_id = <bookingsupplement>-bookingSupplementid
                                                                          booking_id            = <bookingsupplement>-BookingID ) )
          it_booking_supplementx = VALUE ZAI_DMOt_booking_supplement_inx( ( booking_supplement_id = <bookingsupplement>-bookingsupplementid
                                                                          booking_id            = <bookingsupplement>-bookingid
...
**********************************************************************
  METHOD read.
    ...
    DATA: booksuppls_out TYPE ZAI_DMOt_booking_supplement,
          messages       TYPE ZAI_DMOt_message.
...
**********************************************************************
  METHOD rba_Booking.
    DATA: booking_out TYPE ZAI_DMOt_booking,
