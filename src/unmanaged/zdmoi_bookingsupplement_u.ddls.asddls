...
define view entity ZDMOI_BookingSupplement_U
  as select from ZDMObook_suppl as BookingSupplement

  association        to parent ZDMOI_Booking_U as _Booking        on  $projection.TravelID  = _Booking.TravelID
                                                                   and $projection.BookingID = _Booking.BookingID
  association [1..1] to ZDMOI_Travel_U         as _Travel         on  $projection.TravelID  = _Travel.TravelID                                                                         
