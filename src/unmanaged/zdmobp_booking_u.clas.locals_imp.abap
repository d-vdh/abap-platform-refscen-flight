...
CLASS lhc_booking DEFINITION
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_booking_failed   TYPE TABLE FOR FAILED   ZDMOi_booking_u.
    TYPES tt_booking_reported TYPE TABLE FOR REPORTED ZDMOi_booking_u.

    TYPES tt_bookingsupplement_failed   TYPE TABLE FOR FAILED   ZDMOi_bookingsupplement_u.
    TYPES tt_bookingsupplement_reported TYPE TABLE FOR REPORTED ZDMOi_bookingsupplement_u.
...
**********************************************************************
  METHOD update.
    DATA: messages TYPE ZDMOt_message,
          booking  TYPE ZDMObooking,
          bookingx TYPE ZDMOs_booking_inx.
...
**********************************************************************
  METHOD read.
    DATA: travel_out   TYPE ZDMOtravel,
          bookings_out TYPE ZDMOt_booking,
          messages     TYPE ZDMOt_message.
...
***********************************************************************
  METHOD rba_Booksupplement.
    DATA: bookingsupplements_out TYPE ZDMOt_booking_supplement,
          messages               TYPE ZDMOt_message.
...
***********************************************************************
  METHOD cba_Booksupplement.
    DATA: message                   TYPE LINE OF ZDMOt_message,
          messages                  TYPE ZDMOt_message,
          booksupplements_old       TYPE ZDMOt_booking_supplement,
          booksupplement            TYPE ZDMObook_suppl,
          last_bookingsupplement_id TYPE ZDMObooking_supplement_id.
    ...
    LOOP AT entities_cba ASSIGNING FIELD-SYMBOL(<booking>).
      ...
      ELSE.
        ...
        last_bookingsupplement_id = REDUCE #( INIT res TYPE ZDMObooking_supplement_id
    ...
    LOOP AT messages INTO DATA(message).
      IF message-msgty = 'E' OR message-msgty = 'A'.
        APPEND VALUE #( %cid        = cid
                        ...
                        %fail-cause = ZDMOcl_travel_auxiliary=>get_cause_from_message(
                                        msgid = message-msgid
                                        msgno = message-msgno
                                      ) )
            TO failed.
